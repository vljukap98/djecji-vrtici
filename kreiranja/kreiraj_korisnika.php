<?php
    ...
    if(isset($_POST['dodajkor'])) {
        ...
        $sql = "insert into korisnik (OIB_korisnik, ime, prezime, korisnicko_ime, lozinka, lozinka_sha1, email, vrijeme_registracije, aktiviran, uloga_id) values ($oib, '$ime', '$prezime', '$korisnicko_ime', '$lozinka', '$lozinka_sha1', '$email', '$now', true, '3')";
...
<html>
    ...
    <body style="background-image: url(../slike/index-slika.jpg)">
        ...
        <section>
            <form novalidate method="POST" name="form_korisnik" action="kreiraj_korisnika.php">
                <label>OIB:</label><br>
                ...
                <input id="dodajkor" name="dodajkor" type="submit" value="Dodaj novog korisnika" style="font-family: 'Amatic SC', cursive;"/>
            </form>
        </section>
        <footer>
            <address>
